...
public class EftStringUtils {
    ...
    private static final char[] DESTINATION_VIETNAMESE_CHARACTERS = {'A', 'A', 'A', 'A', 'E',
    ...
    public static char removeVietnameseAccent(char c) {
        int index = Arrays.binarySearch(SOURCE_VIETNAMESE_CHARACTERS, c);
        if (index >= 0) {
            c = DESTINATION_VIETNAMESE_CHARACTERS[index];
        }
        return c;
    }
